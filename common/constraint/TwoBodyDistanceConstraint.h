 ...
 */
class TwoBodyDistanceConstraint : public Constraint
{
public:
	...
	TwoBodyDistanceConstraint(RigidBody* bodyA_In, RigidBody* bodyB_In, vec3 rAloc = vec3(0,0,0), vec3 rBloc = vec3(0,0,0))
	{
		this->bodyA = bodyA_In;
		this->bodyB = bodyB_In;
